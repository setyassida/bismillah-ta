...
if __name__ == "__main__":
    ...
    file_path1 = "dataset/data_30000_1.csv"
    file_path2 = "dataset/data_30000_2.csv"
    file_path2 = "dataset/data_30000_3.csv"    
    ...
    window_site2 = calculate_score(window_site2, dimension, grid_range)

    for i in range(window_size):
        if(window_site1[i].dscore < k):
            central_site.append(window_site1[i])
        if(window_site2[i].dscore < k):
            central_site.append(window_site2[i])
            
    print("------CENTRAL SITE-------")
    for i in range(len(central_site)):
        print(central_site[i])

    # calculated_central_site = calculate_score(central_site, dimension, grid_range)
    # print("------CENTRAL SITE-------")
    # for i in range(len(central_site)):
    #     print(central_site[i])
